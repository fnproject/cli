...
func (p *deploycmd) deployCodeOnlyFunc(c *cli.Context, app *models.App, funcfilePath string, funcfile *common.FuncFileV20180708) error {
	...
	archivePath, err := buildCodeOnlyArchive(dir, funcfile)
	if err != nil {
		return err
	}
	...
	return p.createOrUpdateCodeOnlyFunction(app.ID, fn)
}

func (p *deploycmd) createOrUpdateCodeOnlyFunction(appID string, fn *models.Fn) error {
