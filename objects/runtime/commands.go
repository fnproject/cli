...
// ListRuntimes returns the runtimes listing command.
...
// ListRuntimeVersions returns the runtime versions listing command.
...
// GetLatestRuntimeVersion returns the latest runtime version lookup command.
