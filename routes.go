...
func (a *routesCmd) call(c *cli.Context) error {
	...
	content := stdin()
	return client.CallFN(a.provider, appName, route, content, os.Stdout, c.String("method"), c.StringSlice("e"), c.String("content-type"), c.Bool("display-call-id"))
}
